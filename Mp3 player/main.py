...
# bg=PhotoImage(file="C:/iconss/bg1.png")
...
def play_time():
    ...
    song = f'C:/Users/sooja/Downloads/{song}.mp3'
...
def add_song():
	...
	os.chdir(r"C:/Users/sooja/Downloads/song")
	f=os.listdir()
	for s in f:
    ...
    # strip out the diC:/Users/sooja/Downloadsrectory info and .mp3 extension from the song name
    # song = song.replace("C:/Users/sooja/Downloads/", "")
    # song = song.replace(".mp3", "")

    # Add song to listbox
    #song_box.insert(END, path)z


# Add many songs to playlist
def add_many_songs():
	songs = filedialog.askopenfilenames(initialdir="C:/Users/sooja/Downloads", title="choose A song",filetypes=(("mp3 files", "*.mp3"),))
	for song in songs:
		song=song.replace("C:/Users/sooja/Downloads","")
		song=song.replace(".mp3","")
		print(song)
...
#Add Song Function
##	song = filedialog.askopenfilename(initialdir="C:/Users/sooja/Downloads", title="Choose A Song", filetypes=(("mp3 Files", "*.mp3"), ))
...
#	elif int(current_volume) >= 50 and int(current_volume) <= 75:
#		volume_meter.config(image=vol3)
#	elif int(current_volume) >= 75 and int(current_volume) <= 100:C:/Users/sooja/Downloads
#		volume_meter.config(image=vol4)
def createplaylist():
	with open("C:/Users/sooja/Downloads/playlist","a") as f:
		songs = filedialog.askopenfilenames(initialdir="C:/Users/sooja/Downloads", title="choose A song",
...
# bg=PhotoImage(file="C:/iconss/bg1.png")
# label1=Label(master_frame,image=bg)
# label1.place(x=0,y=0)
# Create Playlist Box
...
back_btn_img = PhotoImage(file='C:/iconss/previous1.png')
forwardbtnimg =  PhotoImage(file='C:/iconss/forward2.png')
play_btn_img =  PhotoImage(file='C:/iconss/play2.png')
pause_btn_img =  PhotoImage(file='C:/iconss/pause1.png')
stop_btn_img =  PhotoImage(file='C:/iconss/stop1.png')
...
#v#ol3 = PhotoImage(file='images/volume3.png')
...
forward_button = Button(controls_frame, image=forwardbtnimg, borderwidth=0, command=next_song)
...
playlist_menu.add_command(label="create a playlist",command=createplaylist)
playlist_menu.add_command(label="openplaylist",command=loadplaylist)
